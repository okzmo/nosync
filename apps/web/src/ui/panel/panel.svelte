...
<Drawer.Root direction="left" shouldScaleBackground={false} open={panel.isOpen} dismissible={false}>
	<Drawer.Portal>
		...
		>
			<div
				class="mx-auto flex w-full items-center justify-between px-5 pt-6 text-zinc-50/30 lg:w-[45rem]"
			>
				<button
			...
			<div class="mt-20 px-8 md:mt-20 md:px-14">
				<input
					type="text"
					class="w-full border-b-0 border-l-0 border-r-0 border-t-0 border-zinc-50/30 bg-zinc-950 text-5xl font-bold transition-colors placeholder:text-zinc-50/15 focus:border-zinc-50/50 focus:outline-none focus:ring-0"
					placeholder="Title"
				/>
			</div>
		</Drawer.Content>
